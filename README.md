...
you pick which one has the higher value for a randomly chosen stat (HP, Attack,
Defense, or Speed). Correct guesses grow your streak; a wrong guess ends the run
and shows your final score.
...
- Live streak + in-session best counter
...
high-score persistence via `localStorage`, difficulty modes, sound effects, and
shareable results.
